...
import com.fiap.soat12.tc_group_7.cleanarch.usecase.EmployeeAuthUseCase;
import com.fiap.soat12.tc_group_7.cleanarch.usecase.PasswordManagementUseCase;
...
public class AuthEmployeeRestController {
    ...
    @Operation(summary = "Esqueceu a senha",
            description = "Gera uma senha temporária e a envia ao email do funcionário.")
