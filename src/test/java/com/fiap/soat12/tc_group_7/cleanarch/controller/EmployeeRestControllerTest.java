...
class EmployeeRestControllerTest {
    ...
    @MockitoBean
    private EmployeeAuthUseCase employeeAuthUseCase;
    ...
    void shouldLoginSuccessfully() throws Exception {
        ...
        when(employeeAuthUseCase.auth(any(LoginRequestDTO.class))).thenReturn(responseDTO);

        mockMvc.perform(post("/clean-arch/auth/login")
